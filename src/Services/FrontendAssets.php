...
final class FrontendAssets
{
    private const STYLE_FILES = [
        ...
        'verbum-studio-chapter-revision' => 'frontend/app/src/styles/chapter-revision.css',
        'verbum-studio-general-review' => 'frontend/app/src/styles/general-review.css',
        'verbum-studio-work-versions' => 'frontend/app/src/styles/work-versions.css',
        'verbum-studio-work-audit' => 'frontend/app/src/styles/work-audit.css',
    ...
    private const SCRIPT_FILES = [
        ...
        'frontend/app/src/chapter-revision-runtime.js',
        'frontend/app/src/general-review-runtime.js',
        'frontend/app/src/work-versions-runtime.js',
        'frontend/app/src/work-audit-runtime.js',
        'frontend/app/src/editorial-desk-runtime.js',
        'frontend/app/src/layout-stage-runtime.js',
    ...
    {
        $dependencies = [];
        foreach (self::STYLE_FILES as $handle => $relativePath) { wp_enqueue_style($handle, VERBUM_STUDIO_URL . $relativePath, $dependencies, $this->assetVersion($relativePath)); $dependencies = [$handle]; }
    ...
    private function assetVersion(string $relativePath): string { $path = VERBUM_STUDIO_PATH . $relativePath; $modified = is_file($path) ? filemtime($path) : false; return $modified === false ? VERBUM_STUDIO_VERSION : (string) $modified; }
