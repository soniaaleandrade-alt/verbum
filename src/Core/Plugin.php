...
final class Plugin
{
    ...
    {
        foreach ([
            RestController::class, AuthController::class, LibraryController::class, IdentificationInitialController::class, FoundationLetterSoulController::class, WorkProjectController::class,
