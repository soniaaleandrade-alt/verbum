...
final class Plugin
{
    ...
    public function register(): void
    {
        foreach ([
            ...
            WorkPlanningController::class, StructureDirectionController::class, StructureArchitectureController::class, WorkDevelopmentController::class, WorkChapterPreparationController::class,
