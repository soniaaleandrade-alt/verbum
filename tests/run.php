...
test('config exposes core defaults and production mode', function (): void {
    ...
    assert_same('1.0.0', $config->get('version'));
...
test('capabilities include sprint 01 permissions', function (): void {
...
test('health endpoint returns ok and version', function (): void {
    ...
    assert_same('1.0.0', $data['data']['version']);
});
