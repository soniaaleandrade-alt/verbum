...
const requiredFiles = [
  ...
  'src/auth-profile-runtime.js','src/static-runtime.js','src/workspace-mobile-runtime.js','src/identification-initial-prelude.js','src/identification-runtime.js','src/hom027-journey-runtime.js','src/project-stage-runtime.js','src/foundation-intention-runtime.js','src/foundation-reader-result-runtime.js','src/planning-stage-runtime.js','src/development-stage-runtime.js','src/chapter-workflow-runtime.js','src/chapter-preparation-runtime.js','src/chapter-research-runtime.js','src/chapter-writing-runtime.js','src/revision-hom012-hotfix.js','src/chapter-revision-runtime.js','src/general-review-runtime.js','src/work-versions-runtime.js','src/work-audit-runtime.js','src/editorial-desk-runtime.js','src/layout-stage-runtime.js','src/legal-stage-runtime.js','src/publication-stage-runtime.js','src/technical-runtime.js','src/dashboard-official-runtime.js','src/sidebar-profile-runtime.js','src/minhas-obras-runtime.js','src/profile-polish-runtime.js','src/vite-env.d.ts',
];
...
const buildJs = await readFile(resolve(repoRoot, 'build/verbum-app.js'), 'utf8'); requireAll(buildJs, ['identification-initial-prelude.js','hom027-journey-runtime.js','foundation-reader-result-runtime.js','identification-hom027-polish.css','layout-stage-runtime.js','legal-stage-runtime.js','publication-stage-runtime.js','script.async=false'], 'Static JS build');
...
console.log('Frontend homologation checks passed for Verbum Studio through HOM-030');
